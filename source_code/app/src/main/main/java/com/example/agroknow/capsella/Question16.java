...
public class Question16 extends Activity {


    private RadioGroup radioGroupQuestion16;
    private RadioButton radioButtonQuestion16;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        radioGroupQuestion16 = (RadioGroup) findViewById(R.id.radioGroupQ16);
        Button NextButton = (Button) findViewById(R.id.Q16NextButton);
        NextButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {

                if(radioGroupQuestion16.getCheckedRadioButtonId() != -1) {

                    int selectedId = radioGroupQuestion16.getCheckedRadioButtonId();
                    radioButtonQuestion16 = (RadioButton) findViewById(selectedId);
                    String AnswerQ16 = radioButtonQuestion16.getText().toString();
                    String fileName = "spade.txt";
                    saveDataToFile(AnswerQ16, fileName);


                    Intent myIntent = new Intent(view.getContext(), Question17.class);
    ...
    public void saveDataToFile( String answer, String fileName) {
        ...
        try {
            ...
            myOutWriter.append("  " + "\"decor[" + NumberOfLayers.i + "]\"" + ":" +" "+ "\""+answer+"\","+ "\n");
            myOutWriter.close();
            fOut.close();
        } catch (Exception e) {
...
//            outputStreamWriter.append("  " + "\"decor[" + NumberOfLayers.i + "]\"" + ":" +" "+ "\""+answer+"\","+ "\n");
//
