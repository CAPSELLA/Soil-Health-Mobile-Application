...
public class Question12 extends Activity {

    private RadioGroup radioGroupQuestion12;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        radioGroupQuestion12 = (RadioGroup) findViewById(R.id.radioGroupQ12);
        Button NextButton = (Button) findViewById(R.id.Q12NextButton);
        NextButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {

                if(radioGroupQuestion12.getCheckedRadioButtonId() != -1) {

                    int selectedId = radioGroupQuestion12.getCheckedRadioButtonId();
                    radioButtonQuestion12 = (RadioButton) findViewById(selectedId);
                    String AnswerQ12 = radioButtonQuestion12.getText().toString();

                    String fileName = "spade.txt";
                    saveDataToFile(AnswerQ12, fileName);


                    Intent myIntent = new Intent(view.getContext(), Question13.class);
    ...
    public void saveDataToFile(String answer, String fileName) {
        ...
        try {
            ...
            myOutWriter.append("  " + "\"comp[" + NumberOfLayers.i + "]\"" + ":" +" "+ "\""+answer+"\","+ "\n");
            myOutWriter.close();
            fOut.close();
        } catch (Exception e) {
...
//            outputStreamWriter.append("  " + "\"comp[" + NumberOfLayers.i + "]\"" + ":" +" "+ "\""+answer+"\","+ "\n");
