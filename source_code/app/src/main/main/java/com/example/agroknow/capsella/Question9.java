...
public class Question9 extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Button NextButton = (Button) findViewById(R.id.Q9NextButton);
    ...
    public void saveDataToFile(int answer, String fileName) {
        ...
        try {
            ...
            myOutWriter.append("  " + "\"laydep[" + NumberOfLayers.i + "]\"" + ":" +" "+ answer + ","+"\n" );
            myOutWriter.close();
            fOut.close();
        } catch (Exception e) {
...
//        try {
//
//            //saveDataToFile1(question, answer, fileName);
...
//            outputStreamWriter.append("  " + "\"laydep[" + NumberOfLayers.i + "]\"" + ":" +" "+ answer + ","+"\n" );
