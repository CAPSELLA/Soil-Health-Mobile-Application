...
public class Question22 extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.question22);

        mEdit = (EditText) findViewById(R.id.EditTextQ22);

        Button NextButton = (Button) findViewById(R.id.Q22NextButton);
        NextButton.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {

                String InTextQ22 = mEdit.getText().toString();
                String fileName = "spade.txt";
                saveDataToFile(InTextQ22, fileName);
        ...
        Button SkipButton = (Button) findViewById(R.id.Q22SkipButton);
    ...
    public void saveDataToFile(String answer, String fileName) {
        ...
        try {
            ...
            myOutWriter.append("  " + "\"biodivoth\":" + " " + "\""+answer+"\"," + "\n" );
            myOutWriter.close();
            fOut.close();
        } catch (Exception e) {
...
//            outputStreamWriter.append("  " + "\"biodivoth\":" + " " + "\""+answer+"\"," + "\n" );
